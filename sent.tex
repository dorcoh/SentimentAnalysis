% In reproduce experiment part, we accidentally chose radial kernel svm instead of linear. Fixed % and results now are more reasonable.
% We have cut some of the introduction for adding more concrete examples on the classifiers part
% Also added the fitted decision boundary plot for those specific examples
% The Q&A teasers we've put in some slides also serve as kind of demonstrations, that validate % the students understanding. what do you think?
